import { BaseGraph, IDFSAnalyzer, EdgeCallback, ISearchTask, IEdgeSearch } from "./Graph";
...
declare function dfsAnalysis(g: BaseGraph, start: number, analyzers: IDFSAnalyzer[]): number;
declare function bfsAnalysis(g: BaseGraph, start: number, analyzers: IDFSAnalyzer[]): number;
